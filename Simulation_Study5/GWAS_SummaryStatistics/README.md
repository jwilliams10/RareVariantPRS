<!--
[RICE-ANNOTATION] Simulation_Study5/GWAS_SummaryStatistics
...
# GWAS_SummaryStatistics
    ...
    Scripts to generate GWAS summary statistics from the simulated *training* set for this simulation scenario.
...
- Supplementary Data: simulation sample sizes and related summaries.
    ...
    ## Files
    - `SummaryStats_Train.R`: Generates GWAS summary statistics used as input to common-variant PRS methods.
