...
Train_PVals_All <- get(load(paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation5/Results/GeneCentricCoding/coding_sig",i,".Rdata")))
Train_PVals_All <- Train_PVals_All[Train_PVals_All$STAARB <= 1e-03,]
system(paste0("rm ",paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation5/Results/GeneCentricCoding/coding_sig",i,".Rdata")))

## agds dir
agds_dir <- get(load("/data/williamsjacr/UKB_WES_Full_Processed_Data/agds/agds_dir.Rdata"))

## Null Model
obj_nullmodel_train <- get(load(paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation5/nullmodels_staar/Train_Null_Model",i,".RData")))
obj_nullmodel_tune <- get(load(paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation5/nullmodels_staar/Tune_Null_Model",i,".RData")))
obj_nullmodel_validation <- get(load(paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation5/nullmodels_staar/Validation_Null_Model",i,".RData")))

system(paste0("rm ",paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation5/nullmodels_staar/Train_Null_Model",i,".RData")))
system(paste0("rm ",paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation5/nullmodels_staar/Tune_Null_Model",i,".RData")))
system(paste0("rm ",paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation5/nullmodels_staar/Validation_Null_Model",i,".RData")))
...
write.csv(PRS_Tune,paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation5/Results/Combined_RareVariants_PRS/PRS_Tune_",i,".csv"),row.names = FALSE)
PRS_Validation <- data.frame(IID = pheno_validation$IID,PRS = PRS_Validation)
write.csv(PRS_Validation,paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation5/Results/Combined_RareVariants_PRS/PRS_Validation_",i,".csv"),row.names = FALSE)
...
write.csv(RICE_RV,file = paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation5/Results/Combined_RareVariants_PRS/Best_Betas",i,".csv"),row.names = FALSE)
