...
system(paste0("rm ",paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation4/GWAS_Summary_Statistics/Y_Train",i,".Y.glm.linear")))
system(paste0("rm ",paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation4/GWAS_Summary_Statistics/Y_Train",i,".log")))

obj.bigSNP <- snp_attach("/data/williamsjacr/UKB_WES_Simulation/Simulation4/reference.rds")
...
POS2 <- snp_asGeneticPos(CHR, POS, dir ="/data/williamsjacr/UKB_WES_Simulation/Simulation4/LDPred2_Genetic_Mappings/", ncores = ncores)
NCORES <-  1
...
if(anyNA(corr0@x)){
  ...
  if(file.exists(paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation4/reference",i,".rds"))){
    file.remove(paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation4/reference",i,".rds"))
    file.remove(paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation4/reference",i,".bk"))
  }
  
  snp_subset(obj.bigSNP,ind.row = 1:3000,ind.col = -b,backingfile = paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation4/reference",i))
  
  obj.bigSNP <- snp_attach(paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation4/reference",i,".rds"))
  map <- obj.bigSNP$map[-c(3)]
  names(map) <- c("chr", "rsid", "pos", "a0", "a1") # a1 - alt # c("chr", "pos", "a0", "a1")
...
write.table(prs.file,file = paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation4/Results/LDPred2/ldpred2",i,".txt"),col.names = T,row.names = F,quote=F)

system(paste0("/data/williamsjacr/software/plink2 --score /data/williamsjacr/UKB_WES_Simulation/Simulation4/Results/LDPred2/ldpred2",i,".txt cols=+scoresums,-scoreavgs header no-mean-imputation --score-col-nums 4-",ncol(prs.file)," --bfile /data/williamsjacr/UKB_WES_Simulation/chr22_fulldata/chr22_filtered_common --keep /data/williamsjacr/UKB_WES_Simulation/Simulation4/simulated_data/train.txt --threads 1 --out /data/williamsjacr/UKB_WES_Simulation/Simulation4/Results/LDPred2/prs_train",i))
system(paste0("/data/williamsjacr/software/plink2 --score /data/williamsjacr/UKB_WES_Simulation/Simulation4/Results/LDPred2/ldpred2",i,".txt cols=+scoresums,-scoreavgs header no-mean-imputation --score-col-nums 4-",ncol(prs.file)," --bfile /data/williamsjacr/UKB_WES_Simulation/chr22_fulldata/chr22_filtered_common --keep /data/williamsjacr/UKB_WES_Simulation/Simulation4/simulated_data/tune.txt --threads 1 --out /data/williamsjacr/UKB_WES_Simulation/Simulation4/Results/LDPred2/prs_tune",i))
system(paste0("/data/williamsjacr/software/plink2 --score /data/williamsjacr/UKB_WES_Simulation/Simulation4/Results/LDPred2/ldpred2",i,".txt cols=+scoresums,-scoreavgs header no-mean-imputation --score-col-nums 4-",ncol(prs.file)," --bfile /data/williamsjacr/UKB_WES_Simulation/chr22_fulldata/chr22_filtered_common --keep /data/williamsjacr/UKB_WES_Simulation/Simulation4/simulated_data/validation.txt --threads 1 --out /data/williamsjacr/UKB_WES_Simulation/Simulation4/Results/LDPred2/prs_validation",i))

system(paste0("rm ",paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation4/Results/LDPred2/ldpred2",i,".txt")))
...
write.table(prs.file,file = paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation4/Results/LASSOSUM2/lassosum2",i,".txt"),col.names = T,row.names = F,quote=F)

system(paste0("/data/williamsjacr/software/plink2 --score /data/williamsjacr/UKB_WES_Simulation/Simulation4/Results/LASSOSUM2/lassosum2",i,".txt cols=+scoresums,-scoreavgs header no-mean-imputation --score-col-nums 4-",ncol(prs.file)," --bfile /data/williamsjacr/UKB_WES_Simulation/chr22_fulldata/chr22_filtered_common --keep /data/williamsjacr/UKB_WES_Simulation/Simulation4/simulated_data/train.txt --threads 1 --out /data/williamsjacr/UKB_WES_Simulation/Simulation4/Results/LASSOSUM2/prs_train",i))
system(paste0("/data/williamsjacr/software/plink2 --score /data/williamsjacr/UKB_WES_Simulation/Simulation4/Results/LASSOSUM2/lassosum2",i,".txt cols=+scoresums,-scoreavgs header no-mean-imputation --score-col-nums 4-",ncol(prs.file)," --bfile /data/williamsjacr/UKB_WES_Simulation/chr22_fulldata/chr22_filtered_common --keep /data/williamsjacr/UKB_WES_Simulation/Simulation4/simulated_data/tune.txt --threads 1 --out /data/williamsjacr/UKB_WES_Simulation/Simulation4/Results/LASSOSUM2/prs_tune",i))
system(paste0("/data/williamsjacr/software/plink2 --score /data/williamsjacr/UKB_WES_Simulation/Simulation4/Results/LASSOSUM2/lassosum2",i,".txt cols=+scoresums,-scoreavgs header no-mean-imputation --score-col-nums 4-",ncol(prs.file)," --bfile /data/williamsjacr/UKB_WES_Simulation/chr22_fulldata/chr22_filtered_common --keep /data/williamsjacr/UKB_WES_Simulation/Simulation4/simulated_data/validation.txt --threads 1 --out /data/williamsjacr/UKB_WES_Simulation/Simulation4/Results/LASSOSUM2/prs_validation",i))

system(paste0("rm ",paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation4/Results/LASSOSUM2/lassosum2",i,".txt")))

################

prs_mat_train <- read.delim(paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation4/Results/LDPred2/prs_train",i,".sscore"))
system(paste0("rm ",paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation4/Results/LDPred2/prs_train",i,".log")))
prs_mat_tune <- read.delim(paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation4/Results/LDPred2/prs_tune",i,".sscore"))
system(paste0("rm ",paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation4/Results/LDPred2/prs_tune",i,".log")))
prs_mat_validation <- read.delim(paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation4/Results/LDPred2/prs_validation",i,".sscore"))
system(paste0("rm ",paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation4/Results/LDPred2/prs_validation",i,".log")))
...
write.table(best_prs_validation,file=paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation4/Results/LDPred2/LDpred2_validation_prs_best",i,".txt"),sep = "\t",row.names = FALSE)
...
write.csv(ldpred2_Results,file = paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation4/Results/LDPred2/Best_Betas",i,".csv"),row.names = FALSE)
...
############################### LASSOSUM2
prs_mat_train <- read.delim(paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation4/Results/LASSOSUM2/prs_train",i,".sscore"))
system(paste0("rm ",paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation4/Results/LASSOSUM2/prs_train",i,".log")))
prs_mat_tune <- read.delim(paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation4/Results/LASSOSUM2/prs_tune",i,".sscore"))
system(paste0("rm ",paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation4/Results/LASSOSUM2/prs_tune",i,".log")))
prs_mat_validation <- read.delim(paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation4/Results/LASSOSUM2/prs_validation",i,".sscore"))
system(paste0("rm ",paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation4/Results/LASSOSUM2/prs_validation",i,".log")))
...
write.table(best_prs_validation,file=paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation4/Results/LASSOSUM2/LASSOSUM2_validation_prs_best",i,".txt"),sep = "\t",row.names = FALSE)
...
write.csv(lassosum2_Results,file = paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation4/Results/LASSOSUM2/Best_Betas",i,".csv"),row.names = FALSE)
