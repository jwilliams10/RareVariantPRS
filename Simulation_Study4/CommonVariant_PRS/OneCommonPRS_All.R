...
#Train
prs_train_CT <- read.csv(paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation4/Results/CT/prs_all_train",i,".txt"), sep="")
system(paste0("rm ",paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation4/Results/CT/prs_all_train",i,".txt")))
prs_train_LDPred2 <- read.delim(paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation4/Results/LDPred2/prs_train",i,".sscore"))
system(paste0("rm ",paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation4/Results/LDPred2/prs_train",i,".sscore")))
prs_train_LASSOSum2 <- read.delim(paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation4/Results/LASSOSUM2/prs_train",i,".sscore"))
system(paste0("rm ",paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation4/Results/LASSOSUM2/prs_train",i,".sscore")))
...
#Tune
prs_tune_CT <- read.csv(paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation4/Results/CT/prs_all_tune",i,".txt"), sep="")
system(paste0("rm ",paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation4/Results/CT/prs_all_tune",i,".txt")))
prs_tune_LDPred2 <- read.delim(paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation4/Results/LDPred2/prs_tune",i,".sscore"))
system(paste0("rm ",paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation4/Results/LDPred2/prs_tune",i,".sscore")))
prs_tune_LASSOSum2 <- read.delim(paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation4/Results/LASSOSUM2/prs_tune",i,".sscore"))
system(paste0("rm ",paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation4/Results/LASSOSUM2/prs_tune",i,".sscore")))
...
#Validation
prs_validation_CT <- read.csv(paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation4/Results/CT/prs_all_validation",i,".txt"), sep="")
system(paste0("rm ",paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation4/Results/CT/prs_all_validation",i,".txt")))
prs_validation_LDPred2 <- read.delim(paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation4/Results/LDPred2/prs_validation",i,".sscore"))
system(paste0("rm ",paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation4/Results/LDPred2/prs_validation",i,".sscore")))
prs_validation_LASSOSum2 <- read.delim(paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation4/Results/LASSOSUM2/prs_validation",i,".sscore"))
system(paste0("rm ",paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation4/Results/LASSOSUM2/prs_validation",i,".sscore")))
...
write.table(PRS_Train,file=paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation4/Results/Combined_Common_PRS/Best_Train_All",i,".txt"),sep = "\t",row.names = FALSE)
write.table(PRS_Tune,file=paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation4/Results/Combined_Common_PRS/Best_Tune_All",i,".txt"),sep = "\t",row.names = FALSE)
write.table(PRS_Validation,file=paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation4/Results/Combined_Common_PRS/Best_Validation_All",i,".txt"),sep = "\t",row.names = FALSE)
...
write.csv(RICE_CV,file = paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation4/Results/Combined_Common_PRS/Best_Betas",i,".csv"),row.names = FALSE)