...
common_prs <- read.delim(paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation4/Results/Combined_Common_PRS/Best_Train_All",i,".txt"))

system(paste0("rm ",paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation4/Results/Combined_Common_PRS/Best_Train_All",i,".txt")))
...
save(obj.STAAR.UKB.LDL,file = paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation4/nullmodels_staar/Train_Null_Model",i,".RData"))
...
common_prs <- read.delim(paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation4/Results/Combined_Common_PRS/Best_Tune_All",i,".txt"))
...
save(obj.STAAR.UKB.LDL,file = paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation4/nullmodels_staar/Tune_Null_Model",i,".RData"))
...
common_prs <- read.delim(paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation4/Results/Combined_Common_PRS/Best_Validation_All",i,".txt"))
...
save(obj.STAAR.UKB.LDL,file = paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation4/nullmodels_staar/Validation_Null_Model",i,".RData"))
