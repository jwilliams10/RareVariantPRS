...
## output path
output_path <- "/data/williamsjacr/UKB_WES_Simulation/chr22_fulldata/GeneCentricNoncoding/"
## output file name
output_file_name <- "UKBB_WES_SampleData"
...
save(results_noncoding,file=paste0(output_path,"chr22.Rdata"))
