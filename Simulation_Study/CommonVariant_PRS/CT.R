...
for(i in 1:length(Y_tune)){
  ...
  write.table(dat,file = "/data/williamsjacr/UKB_WES_Simulation/Simulation1/GWAS_Summary_Statistics/tmp.txt",col.names = T,row.names = F,quote=F)
  ...
  system(paste0("/data/williamsjacr/software/plink --bfile /data/williamsjacr/UKB_WES_Simulation/chr22_fulldata/chr22_filtered_common --keep /data/williamsjacr/UKB_WES_Simulation/Simulation1/simulated_data/reference_CT.txt --clump /data/williamsjacr/UKB_WES_Simulation/Simulation1/GWAS_Summary_Statistics/tmp.txt --clump-p1 ",pthr," --clump-r2 ",r2thr,"  --clump-kb ",kbpthr," --out ","/data/williamsjacr/UKB_WES_Simulation/Simulation1/Results/CT/LD_clump"))
  ...
  LD <- as.data.frame(fread("/data/williamsjacr/UKB_WES_Simulation/Simulation1/Results/CT/LD_clump.clumped"))
  ...
  write.table(prs.file,file = "/data/williamsjacr/UKB_WES_Simulation/Simulation1/Results/CT/prs_coeff",col.names = T,row.names = F,quote=F)
  
  # Write p-values to file to use later
  p.value.file <- prs.all[,c("SNP","P")]
  write.table(p.value.file,file = "/data/williamsjacr/UKB_WES_Simulation/Simulation1/Results/CT/p_value",col.names = T,row.names = F,quote=F)
  ...
  write.table(q_range,file = "/data/williamsjacr/UKB_WES_Simulation/Simulation1/Results/CT/q_range_file",row.names = F,col.names = F,quote=F)
  ...
  system("/data/williamsjacr/software/plink2 --q-score-range /data/williamsjacr/UKB_WES_Simulation/Simulation1/Results/CT/q_range_file /data/williamsjacr/UKB_WES_Simulation/Simulation1/Results/CT/p_value header --threads 2 --score /data/williamsjacr/UKB_WES_Simulation/Simulation1/Results/CT/prs_coeff cols=+scoresums,-scoreavgs header no-mean-imputation  --bfile /data/williamsjacr/UKB_WES_Simulation/chr22_fulldata/chr22_filtered_common --keep /data/williamsjacr/UKB_WES_Simulation/Simulation1/simulated_data/train.txt --out /data/williamsjacr/UKB_WES_Simulation/Simulation1/Results/CT/prs_train")
  system("/data/williamsjacr/software/plink2 --q-score-range /data/williamsjacr/UKB_WES_Simulation/Simulation1/Results/CT/q_range_file /data/williamsjacr/UKB_WES_Simulation/Simulation1/Results/CT/p_value header --threads 2 --score /data/williamsjacr/UKB_WES_Simulation/Simulation1/Results/CT/prs_coeff cols=+scoresums,-scoreavgs header no-mean-imputation  --bfile /data/williamsjacr/UKB_WES_Simulation/chr22_fulldata/chr22_filtered_common --keep /data/williamsjacr/UKB_WES_Simulation/Simulation1/simulated_data/tune.txt --out /data/williamsjacr/UKB_WES_Simulation/Simulation1/Results/CT/prs_tune")
  system("/data/williamsjacr/software/plink2 --q-score-range /data/williamsjacr/UKB_WES_Simulation/Simulation1/Results/CT/q_range_file /data/williamsjacr/UKB_WES_Simulation/Simulation1/Results/CT/p_value header --threads 2 --score /data/williamsjacr/UKB_WES_Simulation/Simulation1/Results/CT/prs_coeff cols=+scoresums,-scoreavgs header no-mean-imputation  --bfile /data/williamsjacr/UKB_WES_Simulation/chr22_fulldata/chr22_filtered_common --keep /data/williamsjacr/UKB_WES_Simulation/Simulation1/simulated_data/validation.txt --out /data/williamsjacr/UKB_WES_Simulation/Simulation1/Results/CT/prs_validation")
  ...
  for(k in 1:length(pthres)){
    ...
    prs_temp <- fread(paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation1/Results/CT/prs_train.p_value_",k,".sscore"))
  ...
  for(k in 1:length(pthres)){
    ...
    prs_temp <- fread(paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation1/Results/CT/prs_tune.p_value_",k,".sscore"))
    # times (2*number of SNPs)
    prs_list[[temp]] <- prs_temp[,5:ncol(prs_temp)]
  ...
  for(k in 1:length(pthres)){
    ...
    prs_temp <- fread(paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation1/Results/CT/prs_validation.p_value_",k,".sscore"))
    # times (2*number of SNPs)
    prs_list[[temp]] <- prs_temp[,5:ncol(prs_temp)]
  ...
  write.table(prs_train_max, file = paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation1/Results/CT/prs_train_best",i,".txt"),row.names = F)
  
  prs_tune_max <- pheno_tuning[,c("id",paste0("p_value_",idx))]
  colnames(prs_tune_max) <- c("IID","prs")
  write.table(prs_tune_max, file = paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation1/Results/CT/prs_tune_best",i,".txt"),row.names = F)
  
  prs_vad_max <- pheno_vad[,c("id",paste0("p_value_",idx))]
  colnames(prs_vad_max) <- c("IID","prs")
  write.table(prs_vad_max, file = paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation1/Results/CT/prs_validation_best",i,".txt"),row.names = F)
  ...
  save(ct.result, file = paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation1/Results/CT/CT_result",i,".RData"))
}