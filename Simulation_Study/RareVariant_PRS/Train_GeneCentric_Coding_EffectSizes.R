...
### Significant Results 
load(paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation1/Results/GeneCentricCoding/coding_sig",i,".Rdata"))
...
write.csv(coding_sig,row.names = FALSE,file = paste0(output_path <- "/data/williamsjacr/UKB_WES_Simulation/Simulation1/Results/GeneCentricCoding/Train_EffectSizes",i,".csv"))