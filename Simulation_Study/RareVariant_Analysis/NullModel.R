...
# =============================================================================
# [RICE-ANNOTATION] RareVariant_Analysis/NullModel.R
# Purpose: Fits STAAR/GENESIS null models for rare-variant association testing, using the common-variant PRS as a covariate (train/tune/validation).
#
# Paper linkage:
...
save(obj.STAAR.UKB.LDL,file = paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation1/nullmodels_staar/Train_Null_Model",i,".RData"))
...
save(obj.STAAR.UKB.LDL,file = paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation1/nullmodels_staar/Tune_Null_Model",i,".RData"))
...
save(obj.STAAR.UKB.LDL,file = paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation1/nullmodels_staar/Validation_Null_Model",i,".RData"))
