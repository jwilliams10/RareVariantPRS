# =============================================================================
# [RICE-ANNOTATION] Sim_Characteristics.R
# Purpose: Summarizes simulation design characteristics and generates Supplementary Figure 2.
#
# Paper linkage:
...
h2_dat <- read.csv("/data/williamsjacr/UKB_WES_Simulation/Sim_Characteristics_PropRareVariants.csv")
...
ggsave(paste0("Sim_Characteristics_PropRareVariants.png"),g1,width=10, height=6.18047,dpi = 300)
...
ggsave(paste0("Sim_Characteristics_NewProp.png"),g1,width=10, height=6.18047,dpi = 300)
...
ggsave(paste0("Sim_Characteristics_NewProp_PropRareVariants.png"),g1,width=10, height=6.18047,dpi = 300)
