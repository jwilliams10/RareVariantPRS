...
write.csv(h2_dat,file = "/data/williamsjacr/UKB_WES_Simulation/Sim_Characteristics_NewProp_PropRareVariants.csv",row.names = FALSE)

lapply(Y,function(x){var(x$Y)})
summary(unlist(lapply(Y,function(x){var(x$Y)})))

save(Y,file = paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation7/simulated_data/Y_n_",nrow(Y_hat),"_h2_common_",h2_common,"_h2_rare_",h2_rare,".RData"))
save(Y,file = paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation8/simulated_data/Y_n_",nrow(Y_hat),"_h2_common_",h2_common,"_h2_rare_",h2_rare,".RData"))
