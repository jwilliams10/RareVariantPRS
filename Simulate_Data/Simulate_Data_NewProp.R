# =============================================================================
# [RICE-ANNOTATION] Simulate_Data/Simulate_Data_NewProp.R
# Purpose: Simulates quantitative phenotypes from chromosome 22 using common variants and rare-variant burdens with manuscript-aligned heritability ratio (h2_rare=0.05/12), assuming all rare variants within a causal set contribute to the burden.
#
# Paper linkage:
...
write.csv(h2_dat,file = "/data/williamsjacr/UKB_WES_Simulation/Sim_Characteristics_NewProps.csv",row.names = FALSE)
...
save(Y,file = paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation5/simulated_data/Y_n_",nrow(Y_hat),"_h2_common_",h2_common,"_h2_rare_",h2_rare,".RData"))
save(Y,file = paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation6/simulated_data/Y_n_",nrow(Y_hat),"_h2_common_",h2_common,"_h2_rare_",h2_rare,".RData"))
