# =============================================================================
# [RICE-ANNOTATION] Simulate_Data/FullData/Extract_chr22/gds_processing/Association_Analysis_Prestep.R
...
dir.geno <- "/data/williamsjacr/UKB_WES_Simulation/chr22_fulldata/gds/"
## file name of aGDS, seperate by chr number 
agds_file_name_1 <- "full_gds"
...
###########################################################
## aGDS directory
agds_dir <- paste0(dir.geno,agds_file_name_1,22,agds_file_name_2) 
save(agds_dir,file=paste0(output_path,"full_gds22_agds_dir.Rdata",sep=""))
...
save(Annotation_name_catalog,file=paste0(output_path,"full_gds22_Annotation_name_catalog.Rdata",sep=""))

## Number of jobs for each chromosome
jobs_num <- matrix(rep(0,66),nrow=22)[22,,drop = FALSE]
...
save(jobs_num,file=paste0(output_path,"full_gds22_jobs_num.Rdata",sep=""))
