# =============================================================================
# [RICE-ANNOTATION] AoU/AoU_CV_UKB_RV.R
...
CV_PRS_Tune <- read.delim(paste0("/data/williamsjacr/UKB_WES_Phenotypes/Imputed/AoU_CrossPlatform/",trait,"_RICECV_PRS.sscore"), header=FALSE, comment.char="#")
CV_PRS_Tune <- CV_PRS_Tune[,c(2,5)]
...
CV_PRS_Validation <- read.delim(paste0("/data/williamsjacr/UKB_WES_Phenotypes/Imputed/AoU_CrossPlatform/",trait,"_RICECV_PRS.sscore"), header=FALSE, comment.char="#")
CV_PRS_Validation <- CV_PRS_Validation[,c(2,5)]
...
write.csv(CV_PRS_Results,file = paste0("/data/williamsjacr/UKB_WES_Phenotypes/Imputed/AoU_CV_UKB_RV/",trait,"Best_Betas_RICECV.csv"),row.names = FALSE)
write.csv(CV_Boot_Results,file = paste0("/data/williamsjacr/UKB_WES_Phenotypes/Imputed/AoU_CV_UKB_RV/",trait,"_Bootstraps_RICECV.csv"),row.names = FALSE)
write.csv(RV_PRS_Results,file = paste0("/data/williamsjacr/UKB_WES_Phenotypes/Imputed/AoU_CV_UKB_RV/",trait,"Best_Betas_RICERV.csv"),row.names = FALSE)
write.csv(RV_Boot_Results,file = paste0("/data/williamsjacr/UKB_WES_Phenotypes/Imputed/AoU_CV_UKB_RV/",trait,"_Bootstraps_RICERV.csv"),row.names = FALSE)