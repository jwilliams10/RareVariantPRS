#!/bin/bash --login
# =============================================================================
# [RICE-ANNOTATION] AoU/JointPRS_logTG.sh
...
r1=1; r2=1; r3=1
sst1=/data/williamsjacr/AoU_JointPRS/GWASSumStats/EUR_logTG_GWAS_SumStats_Cleaned.txt; sst2=/data/williamsjacr/AoU_JointPRS/GWASSumStats/AMR_logTG_GWAS_SumStats_Cleaned.txt; sst3=/data/williamsjacr/AoU_JointPRS/GWASSumStats/AFR_logTG_GWAS_SumStats_Cleaned.txt
sample_size1=44668; sample_size2=9794; sample_size3=12549

python /data/williamsjacr/software/JointPRS/JointPRS.py \
--ref_dir=${reference_path} \
--bim_prefix=/data/williamsjacr/AoU_JointPRS/GWASSumStats/EUR_logTG \
--pop=${pop1},${pop2},${pop3} \
--rho_cons=${r1},${r2},${r3} \
