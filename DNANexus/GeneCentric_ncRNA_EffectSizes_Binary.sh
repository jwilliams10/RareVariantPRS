...
dx download UKB_PRS:JW/UKB_Phenotypes/Results/Binary/GeneCentric_ncRNA/${trait}_ncRNA_sig.csv
...
docker run -v $PWD:/data -w /data --entrypoint /bin/bash r_with_plink -l -c "Rscript GeneCentric_ncRNA_EffectSizes_Binary.R ${2}"