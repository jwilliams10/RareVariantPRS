...
dx download UKB_PRS:JW/UKB_Phenotypes/Results/Binary/GeneCentricCoding/${trait}_coding_sig_es.csv
...
docker run -v $PWD:/data -w /data --entrypoint /bin/bash r_with_plink -l -c "Rscript GeneCentric_Coding_PRS_Binary.R ${2}"