# =============================================================================
# [RICE-ANNOTATION] DNANexus/Extract_Betas_All.R
...
# do
# dx run app-swiss-army-knife -iin=UKB_PRS:JW/Software/r_with_plink.tar.gz -iin=UKB_PRS:JW/UKB_Phenotypes/Scripts/Continuous/CommonVariant_PRS/Extract_Betas_All.R -iin=UKB_PRS:JW/UKB_Phenotypes/Scripts/Continuous/CommonVariant_PRS/Extract_Betas_All.sh -icmd="bash Extract_Betas_All.sh ${array}" -y --destination UKB_PRS:JW/UKB_Phenotypes/Results/Continuous/ --priority high --instance-type mem3_ssd1_v2_x32
# done
