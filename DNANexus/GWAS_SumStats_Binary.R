# =============================================================================
# [RICE-ANNOTATION] DNANexus/GWAS_SumStats_Binary.R
...
trait <- c("Breast","Prostate","CAD","T2D","Asthma")[a]
...
if(trait %in% c("Asthma","T2D","Prostate")){
  
  system(paste0("regenie --step 1 --bed subsetted_allchr --phenoFile All_Train_REGENIE.txt --phenoColList ",trait," --covarFile All_Train_REGENIE.txt --covarColList age,age2,sex,pc1,pc2,pc3,pc4,pc5,pc6,pc7,pc8,pc9,pc10 --bt --bsize 1000 --out regenie_step1_",trait))
  system(paste0("regenie --step 2 --bed all_chr --phenoFile All_Train_REGENIE.txt --phenoColList ",trait," --covarFile All_Train_REGENIE.txt --covarColList age,age2,sex,pc1,pc2,pc3,pc4,pc5,pc6,pc7,pc8,pc9,pc10 --pred regenie_step1_",trait,"_pred.list --bt --firth --approx --pThresh 0.05 --bsize 400 --out regenie_step2_",trait))

}else{

  system(paste0("regenie --step 1 --bed subsetted_allchr --phenoFile All_Train_REGENIE.txt --phenoColList ",trait," --covarFile All_Train_REGENIE.txt --covarColList age,age2,pc1,pc2,pc3,pc4,pc5,pc6,pc7,pc8,pc9,pc10 --bt --bsize 1000 --out regenie_step1_",trait))
  system(paste0("regenie --step 2 --bed all_chr --phenoFile All_Train_REGENIE.txt --phenoColList ",trait," --covarFile All_Train_REGENIE.txt --covarColList age,age2,pc1,pc2,pc3,pc4,pc5,pc6,pc7,pc8,pc9,pc10 --pred regenie_step1_",trait,"_pred.list --bt --firth --approx --pThresh 0.05 --bsize 400 --out regenie_step2_",trait))
