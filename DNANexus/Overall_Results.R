...
for(trait in c("BMI","TC","LDL","HDL","logTG","Height")){
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_CT_result_EUR.RData"))
  ct_EUR <- ct.result[[1]]
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_CT_result_NonEur.RData"))
  ct_NonEur <- ct.result[[1]]
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_CT_result_AFR.RData"))
  ct_AFR <- ct.result[[1]]
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_CT_result_EAS.RData"))
  ct_EAS <- ct.result[[1]]
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_CT_result_SAS.RData"))
  ct_SAS <- ct.result[[1]]
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_CT_result_MIX.RData"))
  ct_MIX <- ct.result[[1]]
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_CT_result_UNK.RData"))
  ct_UNK <- ct.result[[1]]
  
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_ldpred2_result_EUR.RData"))
  ldpred2_EUR <- ldpred2.result[[1]]
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_ldpred2_result_NonEur.RData"))
  ldpred2_NonEur <- ldpred2.result[[1]]
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_ldpred2_result_AFR.RData"))
  ldpred2_AFR <- ldpred2.result[[1]]
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_ldpred2_result_EAS.RData"))
  ldpred2_EAS <- ldpred2.result[[1]]
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_ldpred2_result_SAS.RData"))
  ldpred2_SAS <- ldpred2.result[[1]]
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_ldpred2_result_MIX.RData"))
  ldpred2_MIX <- ldpred2.result[[1]]
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_ldpred2_result_UNK.RData"))
  ldpred2_UNK <- ldpred2.result[[1]]
  
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_LASSOSUM2_result_EUR.RData"))
  LASSOSUM2_EUR <- LASSOSUM2.result[[1]]
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_LASSOSUM2_result_NonEur.RData"))
  LASSOSUM2_NonEur <- LASSOSUM2.result[[1]]
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_LASSOSUM2_result_AFR.RData"))
  LASSOSUM2_AFR <- LASSOSUM2.result[[1]]
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_LASSOSUM2_result_EAS.RData"))
  LASSOSUM2_EAS <- LASSOSUM2.result[[1]]
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_LASSOSUM2_result_SAS.RData"))
  LASSOSUM2_SAS <- LASSOSUM2.result[[1]]
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_LASSOSUM2_result_MIX.RData"))
  LASSOSUM2_MIX <- LASSOSUM2.result[[1]]
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_LASSOSUM2_result_UNK.RData"))
  LASSOSUM2_UNK <- LASSOSUM2.result[[1]]
  
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_sl_result_All_Eur.RData"))
  sl_EUR <- SL.result
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_sl_result_All_NonEur.RData"))
  sl_NonEur <- SL.result
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_sl_result_All_AFR.RData"))
  sl_AFR <- SL.result
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_sl_result_All_EAS.RData"))
  sl_EAS <- SL.result
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_sl_result_All_SAS.RData"))
  sl_SAS <- SL.result
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_sl_result_All_MIX.RData"))
  sl_MIX <- SL.result
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_sl_result_All_UNK.RData"))
  sl_UNK <- SL.result
  
  
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_GeneCentric_Coding_Burden_EUR_result.RData"))
  genecentric_coding_burden_EUR <- r2.result_GeneCentric_Coding_Burden
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_GeneCentric_Coding_Burden_NonEur_result.RData"))
  genecentric_coding_burden_NonEur <- r2.result_GeneCentric_Coding_Burden
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_GeneCentric_Coding_Burden_AFR_result.RData"))
  genecentric_coding_burden_AFR <- r2.result_GeneCentric_Coding_Burden
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_GeneCentric_Coding_Burden_EAS_result.RData"))
  genecentric_coding_burden_EAS <- r2.result_GeneCentric_Coding_Burden
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_GeneCentric_Coding_Burden_SAS_result.RData"))
  genecentric_coding_burden_SAS <- r2.result_GeneCentric_Coding_Burden
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_GeneCentric_Coding_Burden_MIX_result.RData"))
  genecentric_coding_burden_MIX <- r2.result_GeneCentric_Coding_Burden
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_GeneCentric_Coding_Burden_UNK_result.RData"))
  genecentric_coding_burden_UNK <- r2.result_GeneCentric_Coding_Burden
  
  
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_GeneCentric_Coding_STAARO_EUR_result.RData"))
  genecentric_coding_STAARO_EUR <- r2.result_GeneCentric_Coding_STAARO
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_GeneCentric_Coding_STAARO_NonEur_result.RData"))
  genecentric_coding_STAARO_NonEur <- r2.result_GeneCentric_Coding_STAARO
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_GeneCentric_Coding_STAARO_AFR_result.RData"))
  genecentric_coding_STAARO_AFR <- r2.result_GeneCentric_Coding_STAARO
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_GeneCentric_Coding_STAARO_EAS_result.RData"))
  genecentric_coding_STAARO_EAS <- r2.result_GeneCentric_Coding_STAARO
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_GeneCentric_Coding_STAARO_SAS_result.RData"))
  genecentric_coding_STAARO_SAS <- r2.result_GeneCentric_Coding_STAARO
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_GeneCentric_Coding_STAARO_MIX_result.RData"))
  genecentric_coding_STAARO_MIX <- r2.result_GeneCentric_Coding_STAARO
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_GeneCentric_Coding_STAARO_UNK_result.RData"))
  genecentric_coding_STAARO_UNK <- r2.result_GeneCentric_Coding_STAARO
  
  
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_GeneCentric_Noncoding_Burden_EUR_result.RData"))
  GeneCentric_Noncoding_burden_EUR <- r2.result_GeneCentric_Noncoding_Burden
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_GeneCentric_Noncoding_Burden_NonEur_result.RData"))
  GeneCentric_Noncoding_burden_NonEur <- r2.result_GeneCentric_Noncoding_Burden
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_GeneCentric_Noncoding_Burden_AFR_result.RData"))
  GeneCentric_Noncoding_burden_AFR <- r2.result_GeneCentric_Noncoding_Burden
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_GeneCentric_Noncoding_Burden_EAS_result.RData"))
  GeneCentric_Noncoding_burden_EAS <- r2.result_GeneCentric_Noncoding_Burden
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_GeneCentric_Noncoding_Burden_SAS_result.RData"))
  GeneCentric_Noncoding_burden_SAS <- r2.result_GeneCentric_Noncoding_Burden
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_GeneCentric_Noncoding_Burden_MIX_result.RData"))
  GeneCentric_Noncoding_burden_MIX <- r2.result_GeneCentric_Noncoding_Burden
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_GeneCentric_Noncoding_Burden_UNK_result.RData"))
  GeneCentric_Noncoding_burden_UNK <- r2.result_GeneCentric_Noncoding_Burden
  
  
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_GeneCentric_Noncoding_STAARO_EUR_result.RData"))
  GeneCentric_Noncoding_STAARO_EUR <- r2.result_GeneCentric_Noncoding_STAARO
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_GeneCentric_Noncoding_STAARO_NonEur_result.RData"))
  GeneCentric_Noncoding_STAARO_NonEur <- r2.result_GeneCentric_Noncoding_STAARO
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_GeneCentric_Noncoding_STAARO_AFR_result.RData"))
  GeneCentric_Noncoding_STAARO_AFR <- r2.result_GeneCentric_Noncoding_STAARO
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_GeneCentric_Noncoding_STAARO_EAS_result.RData"))
  GeneCentric_Noncoding_STAARO_EAS <- r2.result_GeneCentric_Noncoding_STAARO
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_GeneCentric_Noncoding_STAARO_SAS_result.RData"))
  GeneCentric_Noncoding_STAARO_SAS <- r2.result_GeneCentric_Noncoding_STAARO
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_GeneCentric_Noncoding_STAARO_MIX_result.RData"))
  GeneCentric_Noncoding_STAARO_MIX <- r2.result_GeneCentric_Noncoding_STAARO
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_GeneCentric_Noncoding_STAARO_UNK_result.RData"))
  GeneCentric_Noncoding_STAARO_UNK <- r2.result_GeneCentric_Noncoding_STAARO
  
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_sl_result_All_Eur_Burden.RData"))
  SL.result$method <- "SL_Rare_Burden"
  SL_Burden_EUR <- SL.result
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_sl_result_All_NonEur_Burden.RData"))
  SL.result$method <- "SL_Rare_Burden"
  SL_Burden_NonEur <- SL.result
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_sl_result_All_AFR_Burden.RData"))
  SL.result$method <- "SL_Rare_Burden"
  SL_Burden_AFR <- SL.result
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_sl_result_All_EAS_Burden.RData"))
  SL.result$method <- "SL_Rare_Burden"
  SL_Burden_EAS <- SL.result
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_sl_result_All_SAS_Burden.RData"))
  SL.result$method <- "SL_Rare_Burden"
  SL_Burden_SAS <- SL.result
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_sl_result_All_MIX_Burden.RData"))
  SL.result$method <- "SL_Rare_Burden"
  SL_Burden_MIX <- SL.result
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_sl_result_All_UNK_Burden.RData"))
  SL.result$method <- "SL_Rare_Burden"
  SL_Burden_UNK <- SL.result
  
  
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_sl_result_All_Eur_STAARO.RData"))
  SL.result$method <- "SL_Rare_STAARO"
  SL_STAARO_EUR <- SL.result
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_sl_result_All_NonEur_STAARO.RData"))
  SL.result$method <- "SL_Rare_STAARO"
  SL_STAARO_NonEur <- SL.result
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_sl_result_All_AFR_STAARO.RData"))
  SL.result$method <- "SL_Rare_STAARO"
  SL_STAARO_AFR <- SL.result
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_sl_result_All_EAS_STAARO.RData"))
  SL.result$method <- "SL_Rare_STAARO"
  SL_STAARO_EAS <- SL.result
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_sl_result_All_SAS_STAARO.RData"))
  SL.result$method <- "SL_Rare_STAARO"
  SL_STAARO_SAS <- SL.result
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_sl_result_All_MIX_STAARO.RData"))
  SL.result$method <- "SL_Rare_STAARO"
  SL_STAARO_MIX <- SL.result
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_sl_result_All_UNK_STAARO.RData"))
  SL.result$method <- "SL_Rare_STAARO"
  SL_STAARO_UNK <- SL.result
  
  
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_Burden_All_Result_EUR.RData"))
  Combined_Burden_EUR <- SL.result
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_Burden_All_Result_NonEur.RData"))
  Combined_Burden_NonEur <- SL.result
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_Burden_All_Result_AFR.RData"))
  Combined_Burden_AFR <- SL.result
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_Burden_All_Result_EAS.RData"))
  Combined_Burden_EAS <- SL.result
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_Burden_All_Result_SAS.RData"))
  Combined_Burden_SAS <- SL.result
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_Burden_All_Result_MIX.RData"))
  Combined_Burden_MIX <- SL.result
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_Burden_All_Result_UNK.RData"))
  Combined_Burden_UNK <- SL.result
  
  
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_STAARO_All_Result_EUR.RData"))
  Combined_STAARO_EUR <- SL.result
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_STAARO_All_Result_NonEur.RData"))
  Combined_STAARO_NonEur <- SL.result
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_STAARO_All_Result_AFR.RData"))
  Combined_STAARO_AFR <- SL.result
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_STAARO_All_Result_EAS.RData"))
  Combined_STAARO_EAS <- SL.result
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_STAARO_All_Result_SAS.RData"))
  Combined_STAARO_SAS <- SL.result
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_STAARO_All_Result_MIX.RData"))
  Combined_STAARO_MIX <- SL.result
  
  load(paste0("/Users/williamsjacr/Downloads/Results/",trait,"_STAARO_All_Result_UNK.RData"))
