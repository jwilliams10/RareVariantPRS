...
# do
# dx run app-swiss-army-knife -iin=UKB_PRS:JW/Software/r_with_plink.tar.gz -iin=UKB_PRS:JW/UKB_Phenotypes/Scripts/Continuous/Common_Plus_Rare_PRS_Modified.R -iin=UKB_PRS:JW/UKB_Phenotypes/Scripts/Continuous/Common_Plus_Rare_PRS_Modified.sh -icmd="bash Common_Plus_Rare_PRS_Modified.sh ${array}" -y --destination UKB_PRS:JW/UKB_Phenotypes/Results/Continuous/BestPRS/ --priority low --instance-type mem1_ssd1_v2_x4
# done
...
write.csv(rbind(CV_PRS_Results,RV_PRS_Results),file = paste0(trait,"_Modified_Best_Betas.csv"),row.names = FALSE)
