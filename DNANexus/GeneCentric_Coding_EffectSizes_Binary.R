...
trait <- gsub("_coding_sig.csv","",list.files()[str_detect(list.files(),"_coding_sig.csv")])

### Significant Results 
coding_sig <- read_csv(paste0(trait,"_coding_sig.csv"))
colnames(coding_sig) <- c("Gene","Chr","Category","Number_SNV","Burden_1_1","STAAR_O")
...
write.csv(coding_sig,row.names = FALSE,file = paste0(trait,"_coding_sig_array",arrayid,".csv"))

a <- list.files()[list.files() != paste0(trait,"_coding_sig_array",arrayid,".csv")]
