# =============================================================================
# [RICE-ANNOTATION] DNANexus/G_Extraction_Noncoding.R
# Purpose: Extracts/constructs rare-variant burden score matrices (G matrices) for downstream rare-variant testing/PRS.
#
# Paper linkage:
...
# for array in {1..22};
# do
# dx run app-swiss-army-knife -iin=UKB_PRS:JW/Software/r_with_plink.tar.gz -iin=UKB_PRS:JW/UKB_Phenotypes/Scripts/Continuous/RareVariant_PRS/G_Extraction_Noncoding.R -iin=UKB_PRS:JW/UKB_Phenotypes/Scripts/Continuous/RareVariant_PRS/G_Extraction_Noncoding.sh -icmd="bash G_Extraction_Noncoding.sh ${array}" -y --destination UKB_PRS:JW/UKB_Phenotypes/Results/Continuous/G_star/ --priority low --instance-type mem3_ssd1_v2_x8
# done
