...
for(trait in c("BMI","TC","HDL","LDL","logTG","Height")){
  ...
  save(effects,file = paste0(trait,"_Coefficients_All_STAARO.RData"))
  ...
  save(effects,file = paste0(trait,"_Coefficients_All_Burden.RData"))
