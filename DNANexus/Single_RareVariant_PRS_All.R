...
best_beta_raw_RV_AMR <- coef(lm(Y~RV_Coding_PRS,data = RV_PRS_raw_AMR))[2]
se_beta_raw_RV_AMR <- summary(lm(Y~RV_Coding_PRS,data = RV_PRS_raw_AMR))$coefficients[2,2]
...
best_beta_adjusted_RV_AMR <- coef(lm(Y~RV_Coding_PRS,data = RV_PRS_adjusted_AMR))[2]
se_beta_adjusted_RV_AMR <- summary(lm(Y~RV_Coding_PRS,data = RV_PRS_adjusted_AMR))$coefficients[2,2]
...
best_beta_raw_RV_AMR <- coef(lm(Y~RV_Noncoding_PRS,data = RV_PRS_raw_AMR))[2]
se_beta_raw_RV_AMR <- summary(lm(Y~RV_Noncoding_PRS,data = RV_PRS_raw_AMR))$coefficients[2,2]
...
best_beta_adjusted_RV_AMR <- coef(lm(Y~RV_Noncoding_PRS,data = RV_PRS_adjusted_AMR))[2]
se_beta_adjusted_RV_AMR <- summary(lm(Y~RV_Noncoding_PRS,data = RV_PRS_adjusted_AMR))$coefficients[2,2]
