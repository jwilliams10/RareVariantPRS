# =============================================================================
# [RICE-ANNOTATION] DNANexus/RareVariant_Analysis_Noncoding_Preload_Binary.R
...
# for array in {1..379};
# do
# dx run app-swiss-army-knife -iin=UKB_PRS:JW/Software/r_with_plink.tar.gz -iin=UKB_PRS:JW/UKB_Phenotypes/Scripts/Binary/RareVariant_Analysis/RareVariant_Analysis_Noncoding_Preload_Binary.R -iin=UKB_PRS:JW/UKB_Phenotypes/Scripts/Binary/RareVariant_Analysis/RareVariant_Analysis_Noncoding_Preload_Binary.sh -icmd="bash RareVariant_Analysis_Noncoding_Preload_Binary.sh ${trait} ${array}" -y --destination UKB_PRS:JW/UKB_Phenotypes/Results/Binary/GeneCentricNoncoding/ --priority low --extra-args '{"executionPolicy":{"maxSpotTries":5,"spotOnly":true}}' --instance-type mem3_ssd1_v2_x4
# done
# done
