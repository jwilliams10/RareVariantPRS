...
write.table(dat,file = paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation3/GWAS_Summary_Statistics/tmp",i,".txt"),col.names = T,row.names = F,quote=F)
...
system(paste0("/data/williamsjacr/software/plink --bfile /data/williamsjacr/UKB_WES_Simulation/chr22_fulldata/chr22_filtered_common --keep /data/williamsjacr/UKB_WES_Simulation/Simulation3/simulated_data/reference_CT.txt --clump /data/williamsjacr/UKB_WES_Simulation/Simulation3/GWAS_Summary_Statistics/tmp",i,".txt --clump-p1 ",pthr," --clump-r2 ",r2thr,"  --clump-kb ",kbpthr," --out ","/data/williamsjacr/UKB_WES_Simulation/Simulation3/Results/CT/LD_clump",i))

system(paste0("rm /data/williamsjacr/UKB_WES_Simulation/Simulation3/Results/CT/LD_clump",i,".log"))
system(paste0("rm ",paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation3/GWAS_Summary_Statistics/tmp",i,".txt")))
...
LD <- as.data.frame(fread(paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation3/Results/CT/LD_clump",i,".clumped")))
system(paste0("rm ",paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation3/Results/CT/LD_clump",i,".clumped")))
...
write.table(prs.file,file = paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation3/Results/CT/prs_coeff",i),col.names = T,row.names = F,quote=F)

# Write p-values to file to use later
p.value.file <- prs.all[,c("SNP","P")]
write.table(p.value.file,file = paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation3/Results/CT/p_value",i),col.names = T,row.names = F,quote=F)
...
write.table(q_range,file = paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation3/Results/CT/q_range_file",i),row.names = F,col.names = F,quote=F)
...
system(paste0("/data/williamsjacr/software/plink2 --q-score-range /data/williamsjacr/UKB_WES_Simulation/Simulation3/Results/CT/q_range_file",i," /data/williamsjacr/UKB_WES_Simulation/Simulation3/Results/CT/p_value",i," header --threads 2 --score /data/williamsjacr/UKB_WES_Simulation/Simulation3/Results/CT/prs_coeff",i," cols=+scoresums,-scoreavgs header no-mean-imputation  --bfile /data/williamsjacr/UKB_WES_Simulation/chr22_fulldata/chr22_filtered_common --keep /data/williamsjacr/UKB_WES_Simulation/Simulation3/simulated_data/train.txt --out /data/williamsjacr/UKB_WES_Simulation/Simulation3/Results/CT/prs_train",i))
system(paste0("/data/williamsjacr/software/plink2 --q-score-range /data/williamsjacr/UKB_WES_Simulation/Simulation3/Results/CT/q_range_file",i," /data/williamsjacr/UKB_WES_Simulation/Simulation3/Results/CT/p_value",i," header --threads 2 --score /data/williamsjacr/UKB_WES_Simulation/Simulation3/Results/CT/prs_coeff",i," cols=+scoresums,-scoreavgs header no-mean-imputation  --bfile /data/williamsjacr/UKB_WES_Simulation/chr22_fulldata/chr22_filtered_common --keep /data/williamsjacr/UKB_WES_Simulation/Simulation3/simulated_data/tune.txt --out /data/williamsjacr/UKB_WES_Simulation/Simulation3/Results/CT/prs_tune",i))
system(paste0("/data/williamsjacr/software/plink2 --q-score-range /data/williamsjacr/UKB_WES_Simulation/Simulation3/Results/CT/q_range_file",i," /data/williamsjacr/UKB_WES_Simulation/Simulation3/Results/CT/p_value",i," header --threads 2 --score /data/williamsjacr/UKB_WES_Simulation/Simulation3/Results/CT/prs_coeff",i," cols=+scoresums,-scoreavgs header no-mean-imputation  --bfile /data/williamsjacr/UKB_WES_Simulation/chr22_fulldata/chr22_filtered_common --keep /data/williamsjacr/UKB_WES_Simulation/Simulation3/simulated_data/validation.txt --out /data/williamsjacr/UKB_WES_Simulation/Simulation3/Results/CT/prs_validation",i))

system(paste0("rm /data/williamsjacr/UKB_WES_Simulation/Simulation3/Results/CT/prs_train",i,".log"))
system(paste0("rm /data/williamsjacr/UKB_WES_Simulation/Simulation3/Results/CT/prs_tune",i,".log"))
system(paste0("rm /data/williamsjacr/UKB_WES_Simulation/Simulation3/Results/CT/prs_validation",i,".log"))
system(paste0("rm /data/williamsjacr/UKB_WES_Simulation/Simulation3/Results/CT/q_range_file",i))
system(paste0("rm ",paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation3/Results/CT/p_value",i)))
system(paste0("rm ",paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation3/Results/CT/prs_coeff",i)))
...
for(k in 1:length(pthres)){
  ...
  prs_temp <- fread(paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation3/Results/CT/prs_train",i,".p_value_",k,".sscore"))
  system(paste0("rm ",paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation3/Results/CT/prs_train",i,".p_value_",k,".sscore")))
...
write.table(prs_mat_train,file = paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation3/Results/CT/prs_all_train",i,".txt"),row.names = F)

prs_list <- list()
temp <- 1
for(k in 1:length(pthres)){
  
  prs_temp <- fread(paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation3/Results/CT/prs_tune",i,".p_value_",k,".sscore"))
  system(paste0("rm ",paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation3/Results/CT/prs_tune",i,".p_value_",k,".sscore")))
  # times (2*number of SNPs)
  prs_list[[temp]] <- prs_temp[,5:ncol(prs_temp)]
...
write.table(prs_mat_tune,file = paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation3/Results/CT/prs_all_tune",i,".txt"),row.names = F)
...
for(k in 1:length(pthres)){
  ...
  prs_temp <- fread(paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation3/Results/CT/prs_validation",i,".p_value_",k,".sscore"))
  system(paste0("rm ",paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation3/Results/CT/prs_validation",i,".p_value_",k,".sscore")))
  # times (2*number of SNPs)
  prs_list[[temp]] <- prs_temp[,5:ncol(prs_temp)]
...
write.table(prs_mat_validation,file = paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation3/Results/CT/prs_all_validation",i,".txt"),row.names = F)
...
write.table(prs_vad_max, file = paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation3/Results/CT/prs_validation_best",i,".txt"),row.names = F)
...
write.csv(CT_Results,file = paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation3/Results/CT/Best_Betas",i,".csv"),row.names = FALSE)