...
STAARO_Combined_Train<-STAARO_Combined_Train[,c("IID","GeneCentric_Coding_PRS_Threshold_5","GeneCentric_Noncoding_PRS_Threshold_12","SlidingWindow_PRS_Threshold_3")]
...
Burden_Combined_Train <- Burden_Combined_Train[,c("IID","GeneCentric_Coding_PRS_Threshold_4","GeneCentric_Noncoding_PRS_Threshold_12","SlidingWindow_PRS_Threshold_3")]
...
if(arrayid == 1){
  ...
  write.table(prs_best_train,file="/data/williamsjacr/UKB_WES_lipids/Data/Results/LDL/Combined_RareVariants_PRS/BestThree_STAARO_Train_All.txt",sep = "\t",row.names = FALSE)
  ...
  write.table(prs_best_train,file="/data/williamsjacr/UKB_WES_lipids/Data/Results/LDL/Combined_RareVariants_PRS/BestThree_Burden_Train_All.txt",sep = "\t",row.names = FALSE)
