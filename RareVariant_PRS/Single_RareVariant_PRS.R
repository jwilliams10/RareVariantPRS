...
STAARO_Combined_Train <- pheno_train_STAARO[,-c(1:17)]

pheno_train_Burden <- left_join(pheno_train,Burden_Combined_Train,by = "IID")
Burden_Combined_Train <- pheno_train_Burden[,-c(1:17)]
...
STAARO_Combined_Tune <- pheno_tuning_STAARO[,-c(1:17)]

pheno_tuning_Burden <- left_join(pheno_tuning,Burden_Combined_Tune,by = "IID")
Burden_Combined_Tune <- pheno_tuning_Burden[,-c(1:17)]
...
STAARO_Combined_Validation <- pheno_vad_STAARO[,-c(1:17)]

pheno_vad_Burden <- left_join(pheno_vad,Burden_Combined_Validation,by = "IID")
Burden_Combined_Validation <- pheno_vad_Burden[,-c(1:17)]
...
if(arrayid == 1){
  ...
  save(final_coefs,file = "/data/williamsjacr/UKB_WES_lipids/Data/Results/LDL/Combined_RareVariants_PRS/final_coefs_STAARO.RData")
  
  prs_best_validation <- predict(sl, STAARO_Combined_Validation, onlySL = TRUE)[[1]]
  ...
  prs_best_train <- data.frame(IID = pheno_train_STAARO$IID,prs = predict(sl, STAARO_Combined_Train, onlySL = TRUE)[[1]])
  prs_best_tune <- data.frame(IID = pheno_tuning_STAARO$IID,prs = predict(sl, STAARO_Combined_Tune, onlySL = TRUE)[[1]])
  
  write.table(prs_best_train,file="/data/williamsjacr/UKB_WES_lipids/Data/Results/LDL/Combined_RareVariants_PRS/Best_STAARO_Train_All.txt",sep = "\t",row.names = FALSE)
  write.table(prs_best_tune,file="/data/williamsjacr/UKB_WES_lipids/Data/Results/LDL/Combined_RareVariants_PRS/Best_STAARO_Tune_All.txt",sep = "\t",row.names = FALSE)
  write.table(prs_best_validation,file="/data/williamsjacr/UKB_WES_lipids/Data/Results/LDL/Combined_RareVariants_PRS/Best_STAARO_Validation_All.txt",sep = "\t",row.names = FALSE)
  ...
  save(SL.result,file = "/data/williamsjacr/UKB_WES_lipids/Data/Results/LDL/Combined_RareVariants_PRS/sl_result_STAARO.RData") 
}else{
  ##### SL 
  ...
  save(final_coefs,file = "/data/williamsjacr/UKB_WES_lipids/Data/Results/LDL/Combined_RareVariants_PRS/final_coefs_Burden.RData")
  
  prs_best_validation <- predict(sl, Burden_Combined_Validation, onlySL = TRUE)[[1]]
  
  model <- lm(y_vad_Burden~prs_best_validation)
  r2 <- summary(model)$r.square
  
  prs_best_validation <- data.frame(IID = pheno_vad_Burden$IID,prs = prs_best_validation)
  prs_best_train <- data.frame(IID = pheno_train_Burden$IID,prs = predict(sl, Burden_Combined_Train, onlySL = TRUE)[[1]])
  prs_best_tune <- data.frame(IID = pheno_tuning_Burden$IID,prs = predict(sl, Burden_Combined_Tune, onlySL = TRUE)[[1]])
  
  write.table(prs_best_train,file="/data/williamsjacr/UKB_WES_lipids/Data/Results/LDL/Combined_RareVariants_PRS/Best_Burden_Train_All.txt",sep = "\t",row.names = FALSE)
  write.table(prs_best_tune,file="/data/williamsjacr/UKB_WES_lipids/Data/Results/LDL/Combined_RareVariants_PRS/Best_Burden_Tune_All.txt",sep = "\t",row.names = FALSE)
  write.table(prs_best_validation,file="/data/williamsjacr/UKB_WES_lipids/Data/Results/LDL/Combined_RareVariants_PRS/Best_Burden_Validation_All.txt",sep = "\t",row.names = FALSE)
  ...
  save(SL.result,file = "/data/williamsjacr/UKB_WES_lipids/Data/Results/LDL/Combined_RareVariants_PRS/sl_result_Burden.RData")
}
