...
write.csv(PRS,file = paste0("/data/williamsjacr/UKB_WES_lipids/Data/Results/LDL/GeneCentricNonCoding/Train_PRS_Array_",arrayid_original,".csv"),row.names = FALSE)
