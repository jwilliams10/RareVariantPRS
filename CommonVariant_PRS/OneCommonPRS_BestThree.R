...
#Train
prs_train_CT <- read.csv("/data/williamsjacr/UKB_WES_lipids/Data/Results/LDL/CT/prs_train_best.txt", sep="")
prs_train_LDPred2 <- read.delim("/data/williamsjacr/UKB_WES_lipids/Data/Results/LDL/LDPred2/ldpred2_train_prs_best.txt")
prs_train_LASSOSum2 <- read.delim("/data/williamsjacr/UKB_WES_lipids/Data/Results/LDL/LASSOSUM2/lassosum2_train_prs_best.txt")

prs_train_all <- cbind(prs_train_CT[,1:2],prs_train_CT[,-c(1,2)],prs_train_LDPred2[,-c(1,2)],prs_train_LASSOSum2[,-c(1,2)])
colnames(prs_train_all) <- c("IID","FID","CT","LDPred2","LASSOSum2")
...
#Tune
prs_tune_CT <- read.csv("/data/williamsjacr/UKB_WES_lipids/Data/Results/LDL/CT/prs_tune_best.txt", sep="")
prs_tune_LDPred2 <- read.delim("/data/williamsjacr/UKB_WES_lipids/Data/Results/LDL/LDPred2/ldpred2_tune_prs_best.txt")
prs_tune_LASSOSum2 <- read.delim("/data/williamsjacr/UKB_WES_lipids/Data/Results/LDL/LASSOSUM2/lassosum2_tune_prs_best.txt")

prs_tune_all <- cbind(prs_tune_CT[,1:2],prs_tune_CT[,-c(1,2)],prs_tune_LDPred2[,-c(1,2)],prs_tune_LASSOSum2[,-c(1,2)])
colnames(prs_tune_all) <- c("IID","FID","CT","LDPred2","LASSOSum2")
...
#Validation
prs_validation_CT <- read.csv("/data/williamsjacr/UKB_WES_lipids/Data/Results/LDL/CT/prs_validation_best.txt", sep="")
prs_validation_LDPred2 <- read.delim("/data/williamsjacr/UKB_WES_lipids/Data/Results/LDL/LDPred2/ldpred2_validation_prs_best.txt")
prs_validation_LASSOSum2 <- read.delim("/data/williamsjacr/UKB_WES_lipids/Data/Results/LDL/LASSOSUM2/lassosum2_validation_prs_best.txt")

prs_validation_all <- cbind(prs_validation_CT[,1:2],prs_validation_CT[,-c(1,2)],prs_validation_LDPred2[,-c(1,2)],prs_validation_LASSOSum2[,-c(1,2)])
colnames(prs_validation_all) <- c("IID","FID","CT","LDPred2","LASSOSum2")
...
save(final_coefs,file = "/data/williamsjacr/UKB_WES_lipids/Data/Results/LDL/Combined_Common_PRS/final_coefs_bestthree.RData")
...
write.table(prs_best_train,file="/data/williamsjacr/UKB_WES_lipids/Data/Results/LDL/Combined_Common_PRS/Best_Train_BestThree.txt",sep = "\t",row.names = FALSE)
write.table(prs_best_tune,file="/data/williamsjacr/UKB_WES_lipids/Data/Results/LDL/Combined_Common_PRS/Best_Tune_BestThree.txt",sep = "\t",row.names = FALSE)
write.table(prs_best_validation,file="/data/williamsjacr/UKB_WES_lipids/Data/Results/LDL/Combined_Common_PRS/Best_Validation_BestThree.txt",sep = "\t",row.names = FALSE)
...
save(SL.result,file = "/data/williamsjacr/UKB_WES_lipids/Data/Results/LDL/Combined_Common_PRS/sl_result_BestThree.RData")
