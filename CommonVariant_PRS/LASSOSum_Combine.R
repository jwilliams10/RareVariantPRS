...
prs_mat_train <- read.delim("/data/williamsjacr/UKB_WES_lipids/Data/Results/LDL/LASSOSUM2/LASSOSUM2_train_prs_all.txt")
...
best_prs_train <- pheno_train[,c("IID","FID",paste0("SCORE",idx,"_SUM"))]
best_prs_tune <- pheno_tuning[,c("IID","FID",paste0("SCORE",idx,"_SUM"))]
best_prs_validation <- pheno_vad[,c("IID","FID",paste0("SCORE",idx,"_SUM"))]

write.table(best_prs_train,file="/data/williamsjacr/UKB_WES_lipids/Data/Results/LDL/LASSOSUM2/lassosum2_train_prs_best.txt",sep = "\t",row.names = FALSE)
write.table(best_prs_tune,file="/data/williamsjacr/UKB_WES_lipids/Data/Results/LDL/LASSOSUM2/lassosum2_tune_prs_best.txt",sep = "\t",row.names = FALSE)
write.table(best_prs_validation,file="/data/williamsjacr/UKB_WES_lipids/Data/Results/LDL/LASSOSUM2/lassosum2_validation_prs_best.txt",sep = "\t",row.names = FALSE)
