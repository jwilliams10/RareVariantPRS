...
prs_mat_train <- read.delim("/data/williamsjacr/UKB_WES_lipids/Data/Results/LDL/LDPred2/ldpred2_train_prs_all.txt")
...
write.table(best_prs_train,file="/data/williamsjacr/UKB_WES_lipids/Data/Results/LDL/LDPred2/ldpred2_train_prs_best.txt",sep = "\t",row.names = FALSE)
write.table(best_prs_tune,file="/data/williamsjacr/UKB_WES_lipids/Data/Results/LDL/LDPred2/ldpred2_tune_prs_best.txt",sep = "\t",row.names = FALSE)
write.table(best_prs_validation,file="/data/williamsjacr/UKB_WES_lipids/Data/Results/LDL/LDPred2/ldpred2_validation_prs_best.txt",sep = "\t",row.names = FALSE)
