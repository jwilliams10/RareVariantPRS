# =============================================================================
# [RICE-ANNOTATION] Simulation_BetaRatios.R
# Purpose: Summarizes simulation effect-size ratios / components used in simulation result interpretation (linked to Manuscript simulation results).
#
# Paper linkage:
