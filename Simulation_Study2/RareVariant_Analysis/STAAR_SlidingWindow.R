...
## output path
output_path <- "/data/williamsjacr/UKB_WES_Simulation/Simulation2/Results/SlidingWindow/"
...
load(paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation2/Results/SlidingWindow/Train_Analysis",i,".Rdata"))
...
save(slidingwindow_sig,file = paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation2/Results/SlidingWindow/slidingwindow_sig",i,".Rdata"))
...
### Significant Results 
load(paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation2/Results/SlidingWindow/slidingwindow_sig",i,".Rdata"))
...
write.csv(slidingwindow_sig,row.names = FALSE,file = paste0(output_path <- "/data/williamsjacr/UKB_WES_Simulation/Simulation2/Results/SlidingWindow/Train_EffectSizes",i,".csv"))
...
slidingwindow_sig <- read.csv(paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation2/Results/SlidingWindow/Train_EffectSizes",i,".csv"))
...
save(prs_mat,file = paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation2/Results/SlidingWindow/tune_prs_mat",i,".RData"))
...
save(prs_mat,file = paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation2/Results/SlidingWindow/validation_prs_mat",i,".RData"))