...
## output path
output_path <- "/data/williamsjacr/UKB_WES_Simulation/Simulation2/Results/GeneCentricNoncoding/"
...
load(paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation2/Results/GeneCentricNoncoding/Train_Analysis",i,".Rdata"))
noncoding_sig <- NULL
...
save(noncoding_sig,file = paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation2/Results/GeneCentricNoncoding/noncoding_sig",i,".Rdata"))
...
### Significant Results 
load(paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation2/Results/GeneCentricNoncoding/noncoding_sig",i,".Rdata"))
...
write.csv(noncoding_sig,row.names = FALSE,file = paste0(output_path <- "/data/williamsjacr/UKB_WES_Simulation/Simulation2/Results/GeneCentricNoncoding/Train_EffectSizes",i,".csv"))
...
noncoding_sig <- read.csv(paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation2/Results/GeneCentricNoncoding/Train_EffectSizes",i,".csv"))
...
save(prs_mat,file = paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation2/Results/GeneCentricNoncoding/tune_prs_mat",i,".RData"))
...
save(prs_mat,file = paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation2/Results/GeneCentricNoncoding/validation_prs_mat",i,".RData"))
