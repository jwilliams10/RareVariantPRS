...
if(anyNA(corr0@x)){
  ...
  bigsnpr::snp_subset(obj.bigSNP,ind.row = 1:3000,ind.col = -b,backingfile = paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation2/reference",i))
...
save(ldpred2.result,file = paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation2/Results/LDPred2/ldpred2_result",i,".RData"))
...
save(lassosum2.result,file = paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation2/Results/LASSOSUM2/lassosum2_result",i,".RData"))
