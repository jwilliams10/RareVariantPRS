...
save(SL.result,file = paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation2/Results/Combined_Common_PRS/sl_result_All_Eur",i,".RData"))
...
save(SL.result,file = paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation2/Results/Combined_Common_PRS/sl_result_All_NonEur",i,".RData"))
...
save(SL.result,file = paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation2/Results/Combined_Common_PRS/sl_result_All_UNK",i,".RData"))
...
save(SL.result,file = paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation2/Results/Combined_Common_PRS/sl_result_All_SAS",i,".RData"))
...
save(SL.result,file = paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation2/Results/Combined_Common_PRS/sl_result_All_MIX",i,".RData"))
...
save(SL.result,file = paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation2/Results/Combined_Common_PRS/sl_result_All_AFR",i,".RData"))
...
save(SL.result,file = paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation2/Results/Combined_Common_PRS/sl_result_All_EAS",i,".RData"))
