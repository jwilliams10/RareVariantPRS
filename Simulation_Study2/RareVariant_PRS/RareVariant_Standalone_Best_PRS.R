...
save(r2.result_GeneCentric_Coding_STAARO, file = paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation2/Results/GeneCentricCoding/GeneCentric_Coding_STAARO_result",i,".RData"))
...
save(r2.result_GeneCentric_Coding_Burden, file = paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation2/Results/GeneCentricCoding/GeneCentric_Coding_Burden_result",i,".RData"))
...
save(r2.result_GeneCentric_Noncoding_STAARO, file = paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation2/Results/GeneCentricNoncoding/GeneCentric_Noncoding_STAARO_result",i,".RData"))
...
save(r2.result_GeneCentric_Noncoding_Burden, file = paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation2/Results/GeneCentricNoncoding/GeneCentric_Noncoding_Burden_result",i,".RData"))
...
save(r2.result_SlidingWindow_STAARO, file = paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation2/Results/SlidingWindow/SlidingWindow_STAARO_result",i,".RData"))
...
save(r2.result_SlidingWindow_Burden, file = paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation2/Results/SlidingWindow/SlidingWindow_Burden_result",i,".RData"))
