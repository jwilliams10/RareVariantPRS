...
write.csv(PRS_Tune,paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation2/Results/Combined_RareVariants_PRS/PRS_Tune_",i,".csv"),row.names = FALSE)
PRS_Validation <- data.frame(IID = pheno_validation$IID,PRS = PRS_Validation)
write.csv(PRS_Validation,paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation2/Results/Combined_RareVariants_PRS/PRS_Validation_",i,".csv"),row.names = FALSE)
...
write.csv(RICE_RV,file = paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation2/Results/Combined_RareVariants_PRS/Best_Betas",i,".csv"),row.names = FALSE)
