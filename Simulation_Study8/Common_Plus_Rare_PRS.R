...
CV_PRS_Tune <- read.delim(paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation8/Results/Combined_Common_PRS/Best_Tune_All",i,".txt"))
colnames(CV_PRS_Tune) <- c("IID","CV_PRS")
pheno_tune <- inner_join(pheno_tune,CV_PRS_Tune)
RV_PRS_Tune <- read.csv(paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation8/Results/Combined_RareVariants_PRS/PRS_Tune_",i,".csv"))
...
CV_PRS_Validation <- read.delim(paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation8/Results/Combined_Common_PRS/Best_Validation_All",i,".txt"))
colnames(CV_PRS_Validation) <- c("IID","CV_PRS")
pheno_validation <- inner_join(pheno_validation,CV_PRS_Validation)
RV_PRS_Validation <- read.csv(paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation8/Results/Combined_RareVariants_PRS/PRS_Validation_",i,".csv"))
colnames(RV_PRS_Validation) <- c("IID","RV_PRS")
pheno_validation <- inner_join(pheno_validation,RV_PRS_Validation)
CT_PRS_Validation <- read.delim(paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation8/Results/CT/prs_validation_best",i,".txt"),sep = " ",header = TRUE)
colnames(CT_PRS_Validation) <- c("IID","CT_PRS")
pheno_validation <- inner_join(pheno_validation,CT_PRS_Validation)
LDpred2_PRS_Validation <- read.delim(paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation8/Results/LDPred2/LDpred2_validation_prs_best",i,".txt"),sep = "\t",header = TRUE)
colnames(LDpred2_PRS_Validation) <- c("IID","LDpred2_PRS")
pheno_validation <- inner_join(pheno_validation,LDpred2_PRS_Validation)
Lassosum2_PRS_Validation <- read.delim(paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation8/Results/LASSOSUM2/LASSOSUM2_validation_prs_best",i,".txt"),sep = "\t",header = TRUE)
...
system(paste0("rm ",paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation8/Results/Combined_Common_PRS/Best_Tune_All",i,".txt")))
system(paste0("rm ",paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation8/Results/Combined_RareVariants_PRS/PRS_Tune_",i,".csv")))

system(paste0("rm ",paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation8/Results/Combined_Common_PRS/Best_Validation_All",i,".txt")))
system(paste0("rm ",paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation8/Results/Combined_RareVariants_PRS/PRS_Validation_",i,".csv")))

system(paste0("rm ",paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation8/Results/CT/prs_validation_best",i,".txt")))
system(paste0("rm ",paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation8/Results/LDPred2/LDpred2_validation_prs_best",i,".txt")))
system(paste0("rm ",paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation8/Results/LASSOSUM2/LASSOSUM2_validation_prs_best",i,".txt")))
...
write.csv(Comparison_Boot_Results,file = paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation8/Results/Common_plus_RareVariants/Comparison_Bootstraps",i,".csv"),row.names = FALSE)                             
write.csv(CV_PRS_Results,file = paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation8/Results/Common_plus_RareVariants/CV_Best_Betas",i,".csv"),row.names = FALSE)
write.csv(CV_Boot_Results,file = paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation8/Results/Common_plus_RareVariants/CV_",i,"_Bootstraps.csv"),row.names = FALSE)
write.csv(RV_PRS_Results,file = paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation8/Results/Common_plus_RareVariants/RV_Best_Betas",i,".csv"),row.names = FALSE)
write.csv(RV_Boot_Results,file = paste0("/data/williamsjacr/UKB_WES_Simulation/Simulation8/Results/Common_plus_RareVariants/RV_",i,"_Bootstraps.csv"),row.names = FALSE)
