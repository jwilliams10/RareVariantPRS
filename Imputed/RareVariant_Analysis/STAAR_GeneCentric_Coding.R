# =============================================================================
# [RICE-ANNOTATION] Imputed/RareVariant_Analysis/STAAR_GeneCentric_Coding.R
...
time <- system.time({
  ...
  if(arrayid == 0){
    arrayid <- 379
    trait <- c(continuous_traits,binary_traits)[index/379]
  }else{
    trait <- c(continuous_traits,binary_traits)[floor(index/379) + 1]
  }
...
save(time,file=paste0(output_path,output_file_name,"_",arrayid,"_Time.Rdata"))
