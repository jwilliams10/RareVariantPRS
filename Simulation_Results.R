...
overall_results$Method <- factor(overall_results$Method,levels = c("CT","LDPred","LASSOSum","CV_SL","RV","CV"))
overall_results$Method1[overall_results$Method1 == "RV"] <- "CV"
overall_results$Method1 <- factor(overall_results$Method1,levels = c("CT","LDPred","LASSOSum","CV_SL","CV"))
