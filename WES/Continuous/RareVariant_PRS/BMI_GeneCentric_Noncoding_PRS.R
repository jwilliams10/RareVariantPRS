...
write.csv(PRS,file = paste0("/data/williamsjacr/UKB_WES_Phenotypes/Continuous/Results/GeneCentricNoncoding/PRS_Array_",arrayid_original,".csv"),row.names = FALSE)