...
for(trait in c("BMI","LDL","HDL","logTG","TC","Height")){
  dat <- read.delim(paste0("/data/williamsjacr/UKB_WES_Phenotypes/Continuous/GWAS_Summary_Statistics/",trait,"_sumstats_newpcs.",trait,".glm.linear"), header=FALSE, comment.char="#")
  ...
  system(paste0("ldsc.py",
                ...
                " --out /data/williamsjacr/UKB_WES_Phenotypes/Continuous/LDSC/",trait,"_newpcs_LDSC_Results"))
}