...
for(i in 1:22){
  system(paste0("/data/williamsjacr/software/plink2 --bfile /data/williamsjacr/UKB_WES_lipids/Data/pVCF/chr",i,"/ukbb_wes_200k_chr",i,"_common --keep /data/williamsjacr/UKB_WES_lipids/Data/reference.txt --make-bed --out /data/williamsjacr/UKB_WES_lipids/Data/split_bed/ukbb_wes_200k_chr",i,"_common_reference"))
}
