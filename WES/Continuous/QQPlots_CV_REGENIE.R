...
for(trait in c("BMI","LDL","HDL","logTG","TC","Height")){
  ...
  ggsave(paste0(trait,"_UKB_WES_CV_REGENIE_Manhattan_Plot.png"),p1,width = 15,height = 9.27070457355,dpi = 300)
  
  png(paste0(trait,"_UKB_WES_CV_REGENIE_QQplot.png"), width=10, height=10,units = "in",res = 300)
...
write.csv(lambda_dat,file = "UKB_WES_REGENIE_lambda.csv",row.names = FALSE)