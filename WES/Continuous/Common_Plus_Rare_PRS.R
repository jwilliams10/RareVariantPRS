...
CT_PRS_Validation <- read.delim(paste0("/data/williamsjacr/UKB_WES_Phenotypes/Continuous/Results/CT/",trait,"_prs_validation_best.txt"),sep = " ",header = TRUE)
...
LDpred2_PRS_Validation <- read.delim(paste0("/data/williamsjacr/UKB_WES_Phenotypes/Continuous/Results/LDPred2/",trait,"_ldpred2_validation_prs_best.txt"),sep = "\t",header = TRUE)
colnames(LDpred2_PRS_Validation) <- c("IID","LDpred2_PRS")
pheno_validation <- inner_join(pheno_validation,LDpred2_PRS_Validation)
Lassosum2_PRS_Validation <- read.delim(paste0("/data/williamsjacr/UKB_WES_Phenotypes/Continuous/Results/LASSOSUM2/",trait,"_lassosum2_validation_prs_best.txt"),sep = "\t",header = TRUE)
...
write.csv(Comparison_Boot_Results,file = paste0("/data/williamsjacr/UKB_WES_Phenotypes/Continuous/Results/Common_plus_RareVariants/",trait,"_Comparison_Bootstraps.csv"),row.names = FALSE)               
...
write.csv(CV_Boot_Results,file = paste0("/data/williamsjacr/UKB_WES_Phenotypes/Continuous/Results/Common_plus_RareVariants/CV_",trait,"_Bootstraps.csv"),row.names = FALSE)
...
write.csv(RV_Boot_Results,file = paste0("/data/williamsjacr/UKB_WES_Phenotypes/Continuous/Results/Common_plus_RareVariants/RV_",trait,"_Bootstraps.csv"),row.names = FALSE)
