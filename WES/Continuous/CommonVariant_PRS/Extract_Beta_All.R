...
test_validation <- read.delim(paste0("/data/williamsjacr/UKB_WES_Phenotypes/Continuous/test_validation_",trait,".sscore"), header=FALSE, comment.char="#")
test_validation <- test_validation[,c(2,5:ncol(test_validation))]
prs_all_validation <- read.csv(paste0("/data/williamsjacr/UKB_WES_Phenotypes/Continuous/Results/CT/",trait,"_prs_all_validation.txt"), sep="")
...
test_validation <- read.delim(paste0("/data/williamsjacr/UKB_WES_Phenotypes/Continuous/test_validation_",trait,".sscore"), header=FALSE, comment.char="#")
test_validation <- test_validation[,c(2,5:ncol(test_validation))]
prs_all_validation <- read.csv(paste0("/data/williamsjacr/UKB_WES_Phenotypes/Continuous/Results/LDPred2/",trait,"_prs_validation.sscore"), sep="")
...
test_validation <- read.delim(paste0("/data/williamsjacr/UKB_WES_Phenotypes/Continuous/test_validation_",trait,".sscore"), header=FALSE, comment.char="#")
test_validation <- test_validation[,c(2,5:ncol(test_validation))]
prs_all_validation <- read.csv(paste0("/data/williamsjacr/UKB_WES_Phenotypes/Continuous/Results/LASSOSUM2/",trait,"_prs_validation.sscore"), sep="")
prs_all_validation <- prs_all_validation[,c(2,5:ncol(prs_all_validation))]
colnames(test_validation) <- colnames(prs_all_validation)
all.equal(test_validation,prs_all_validation)
...
Best_Validation_All <- read.delim(paste0("/data/williamsjacr/UKB_WES_Phenotypes/Continuous/Results/Combined_Common_PRS/",trait,"_Best_Validation_All.txt"))
test_validation <- read.delim(paste0("/data/williamsjacr/UKB_WES_Phenotypes/Continuous/test_validation_",trait,".sscore"), header=FALSE, comment.char="#")
...
system(paste0("rm /data/williamsjacr/UKB_WES_Phenotypes/Continuous/test_validation_",trait,".sscore"))
system(paste0("rm /data/williamsjacr/UKB_WES_Phenotypes/Continuous/test_validation_",trait,".log"))
