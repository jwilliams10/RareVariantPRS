...
save(ct.result, file = paste0("/data/williamsjacr/UKB_WES_Phenotypes/Continuous/Results/CT/",trait,"_CT_result_EUR.RData")) 
...
## Save the R2 for the validation set w/ its confidence bounds, as well as the R2 tuning vector
ct.result <- list(r2.result,r2_tun_vec)
save(ct.result, file = paste0("/data/williamsjacr/UKB_WES_Phenotypes/Continuous/Results/CT/",trait,"_CT_result_NonEur.RData")) 
...
## Save the R2 for the validation set w/ its confidence bounds, as well as the R2 tuning vector
ct.result <- list(r2.result,r2_tun_vec)
save(ct.result, file = paste0("/data/williamsjacr/UKB_WES_Phenotypes/Continuous/Results/CT/",trait,"_CT_result_UNK.RData")) 
...
## Save the R2 for the validation set w/ its confidence bounds, as well as the R2 tuning vector
ct.result <- list(r2.result,r2_tun_vec)
save(ct.result, file = paste0("/data/williamsjacr/UKB_WES_Phenotypes/Continuous/Results/CT/",trait,"_CT_result_SAS.RData")) 
...
## Save the R2 for the validation set w/ its confidence bounds, as well as the R2 tuning vector
ct.result <- list(r2.result,r2_tun_vec)
save(ct.result, file = paste0("/data/williamsjacr/UKB_WES_Phenotypes/Continuous/Results/CT/",trait,"_CT_result_MIX.RData"))
...
## Save the R2 for the validation set w/ its confidence bounds, as well as the R2 tuning vector
ct.result <- list(r2.result,r2_tun_vec)
save(ct.result, file = paste0("/data/williamsjacr/UKB_WES_Phenotypes/Continuous/Results/CT/",trait,"_CT_result_AFR.RData"))
...
## Save the R2 for the validation set w/ its confidence bounds, as well as the R2 tuning vector
ct.result <- list(r2.result,r2_tun_vec)
save(ct.result, file = paste0("/data/williamsjacr/UKB_WES_Phenotypes/Continuous/Results/CT/",trait,"_CT_result_EAS.RData"))
