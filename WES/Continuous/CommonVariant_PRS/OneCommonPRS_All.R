...
write.csv(Results$Coefficients,file = paste0("/data/williamsjacr/UKB_WES_Phenotypes/Continuous/Results/Combined_Common_PRS/",trait,"_final_coef.csv"),row.names = FALSE)
...
write.csv(CV_Boot_Results,file = paste0("/data/williamsjacr/UKB_WES_Phenotypes/Continuous/Results/Combined_Common_PRS/",trait,"_Bootstraps.csv"),row.names = FALSE) 