...
for(trait in c("BMI","TC","HDL","LDL","logTG","Height")){
  ...
  full_results_Boot_Comparison <- rbind(full_results_Boot_Comparison,read.csv(paste0("/data/williamsjacr/UKB_WES_Phenotypes/Continuous/Results/Common_plus_RareVariants/",trait,"_Comparison_Bootstraps.csv")))
}
...
scale_color_Publication <- function(...){
  library(scales)
  discrete_scale("color","Publication",manual_pal(values = c("#5EBD3E","#FFB900","#F78200","#E23838","#973999","#009cdf")), ...)
...
ggsave(paste0("UKB_WES_Continuous_","A","_Raw_vs_AncestryAdjusted_Beta.png"),g1,width=10, height=6.18047,dpi = 300)
...
ggsave(paste0("UKB_WES_Continuous_","B","_Raw_vs_AncestryAdjusted_Beta.png"),g1,width=10, height=6.18047,dpi = 300)
...
ggsave(paste0("UKB_WES_Continuous_","C","_Raw_vs_AncestryAdjusted_Beta.png"),g1,width=10, height=6.18047,dpi = 300)
...
ggsave(paste0("UKB_WES_Continuous_Adjusted_Beta.png"),g2,width=10, height=6.18047,dpi = 300)
...
# ggsave(paste0("Desktop/RareVariantPRS_Results/Figures/UKB_WES_Continuous_Adjusted_R2.png"),g2,width=10, height=6.18047,dpi = 300)
ggsave(paste0("UKB_WES_Continuous_Adjusted_R2.png"),g2,width=10, height=6.18047,dpi = 300)
