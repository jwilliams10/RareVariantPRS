...
for(trait in c("BMI","TC","HDL","LDL","logTG","Height")){
  ...
  file.rename("/data/williamsjacr/UKB_WES_Phenotypes/Continuous/Results/GeneCentricNoncoding/noncoding_sig.csv",paste0("/data/williamsjacr/UKB_WES_Phenotypes/Continuous/Results/GeneCentricNoncoding/",trait,"_noncoding_sig.csv"))
