...
write.csv(ldpred2_Boot_Results,file = paste0("/data/williamsjacr/UKB_WES_Phenotypes/Binary/Results/LDPred2/",trait,"_Bootstraps.csv"),row.names = FALSE)
...
write.csv(lassosum2_Boot_Results,file = paste0("/data/williamsjacr/UKB_WES_Phenotypes/Binary/Results/LASSOSUM2/",trait,"_Bootstraps.csv"),row.names = FALSE) 
