...
source("~/RareVariantPRS/WES/Binary/RareVariant_PRS/Gene_Centric_Coding_Burden_Effect_Size_Jake.R")
...
### Significant Results 
coding_sig <- read_csv(paste0("/data/williamsjacr/UKB_WES_Phenotypes/Binary/Results/GeneCentricCoding/",trait,"_coding_sig.csv"))
...
write.csv(coding_sig,row.names = FALSE,file = paste0("/data/williamsjacr/UKB_WES_Phenotypes/Binary/Results/GeneCentricCoding/",trait,"_coding_sig_chr",arrayid,".csv"))