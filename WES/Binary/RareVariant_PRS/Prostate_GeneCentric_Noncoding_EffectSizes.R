...
## source code
source("~/RareVariantPRS/WES/Binary/RareVariant_PRS/Burden_Effect_Size.R")
source("~/RareVariantPRS/WES/Binary//RareVariant_PRS/Gene_Centric_Noncoding_Burden_Effect_Size_Jake.R")

###########################################################
#           User Input
###########################################################
### Significant Results 
noncoding_sig <- read_csv(paste0("/data/williamsjacr/UKB_WES_Phenotypes/Binary/Results/GeneCentricNoncoding/",trait,"_noncoding_sig.csv"))
...
write.csv(noncoding_sig,row.names = FALSE,file = paste0("/data/williamsjacr/UKB_WES_Phenotypes/Binary/Results/GeneCentricNoncoding/",trait,"_noncoding_sigchr",arrayid,".csv"))
