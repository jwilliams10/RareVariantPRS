...
for(trait in c("Asthma","CAD","T2D","Breast","Prostate")){
  ...
  if(arrayid == 1){
    ...
    save(final_coefs,file = paste0("/data/williamsjacr/UKB_WES_Phenotypes/Binary/Results/Combined_RareVariants_PRS/",trait,"_final_coefs_All_STAARO.RData"))
    ...
    save(SL.result,file = paste0("/data/williamsjacr/UKB_WES_Phenotypes/Binary/Results/Combined_RareVariants_PRS/",trait,"_sl_result_All_NonEur_STAARO.RData"))
    ...
    save(SL.result,file = paste0("/data/williamsjacr/UKB_WES_Phenotypes/Binary/Results/Combined_RareVariants_PRS/",trait,"_sl_result_All_UNK_STAARO.RData"))
    ...
    save(SL.result,file = paste0("/data/williamsjacr/UKB_WES_Phenotypes/Binary/Results/Combined_RareVariants_PRS/",trait,"_sl_result_All_SAS_STAARO.RData"))
    ...
    save(SL.result,file = paste0("/data/williamsjacr/UKB_WES_Phenotypes/Binary/Results/Combined_RareVariants_PRS/",trait,"_sl_result_All_MIX_STAARO.RData"))
    ...
    save(SL.result,file = paste0("/data/williamsjacr/UKB_WES_Phenotypes/Binary/Results/Combined_RareVariants_PRS/",trait,"_sl_result_All_AFR_STAARO.RData"))
    ...
    save(SL.result,file = paste0("/data/williamsjacr/UKB_WES_Phenotypes/Binary/Results/Combined_RareVariants_PRS/",trait,"_sl_result_All_EAS_STAARO.RData"))
    ...
    save(final_coefs,file = paste0("/data/williamsjacr/UKB_WES_Phenotypes/Binary/Results/Combined_RareVariants_PRS/",trait,"_final_coefs_All_Burden.RData"))
    ...
    save(SL.result,file = paste0("/data/williamsjacr/UKB_WES_Phenotypes/Binary/Results/Combined_RareVariants_PRS/",trait,"_sl_result_All_NonEur_Burden.RData"))
    ...
    save(SL.result,file = paste0("/data/williamsjacr/UKB_WES_Phenotypes/Binary/Results/Combined_RareVariants_PRS/",trait,"_sl_result_All_UNK_Burden.RData"))
    ...
    save(SL.result,file = paste0("/data/williamsjacr/UKB_WES_Phenotypes/Binary/Results/Combined_RareVariants_PRS/",trait,"_sl_result_All_SAS_Burden.RData"))
    ...
    save(SL.result,file = paste0("/data/williamsjacr/UKB_WES_Phenotypes/Binary/Results/Combined_RareVariants_PRS/",trait,"_sl_result_All_MIX_Burden.RData"))
    ...
    save(SL.result,file = paste0("/data/williamsjacr/UKB_WES_Phenotypes/Binary/Results/Combined_RareVariants_PRS/",trait,"_sl_result_All_AFR_Burden.RData"))
    ...
    save(SL.result,file = paste0("/data/williamsjacr/UKB_WES_Phenotypes/Binary/Results/Combined_RareVariants_PRS/",trait,"_sl_result_All_EAS_Burden.RData"))
  }
}
