...
source("~/RareVariantPRS/WES/Binary/RareVariant_PRS/Sliding_Window_Burden_Effect_Size.R")

###########################################################
#           User Input
###########################################################
### Significant Results 
sliding_window_sig <- read_csv(paste0("/data/williamsjacr/UKB_WES_Phenotypes/Binary/Results/SlidingWindow/",trait,"_sliding_window_sig.csv"))
...
write.csv(sliding_window_sig,row.names = FALSE,file = paste0("/data/williamsjacr/UKB_WES_Phenotypes/Binary/Results/SlidingWindow/",trait,"_sliding_window_sig_array",arrayid,".csv"))
