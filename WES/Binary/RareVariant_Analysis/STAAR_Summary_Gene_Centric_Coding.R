...
for(trait in c("Asthma","CAD","T2D","Breast","Prostate")){
  ...
  file.rename("/data/williamsjacr/UKB_WES_Phenotypes/Binary/Results/GeneCentricCoding/coding_sig.csv",paste0("/data/williamsjacr/UKB_WES_Phenotypes/Binary/Results/GeneCentricCoding/",trait,"_coding_sig.csv"))
