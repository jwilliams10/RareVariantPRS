...
for(trait in c("Asthma","CAD","T2D","Breast","Prostate")){
  ...
  file.rename("/data/williamsjacr/UKB_WES_Phenotypes/Binary/Results/GeneCentricNoncoding/noncoding_sig.csv",paste0("/data/williamsjacr/UKB_WES_Phenotypes/Binary/Results/GeneCentricNoncoding/",trait,"_noncoding_sig.csv"))
