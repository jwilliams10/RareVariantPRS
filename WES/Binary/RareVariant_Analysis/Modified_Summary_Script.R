...
input_path <- "/data/williamsjacr/UKB_WES_Phenotypes/Binary/Results/GeneCentricCoding/"
...
# 
# ncRNA_jobs_num <- 223
# ncRNA_input_path <- "/data/williamsjacr/UKB_WES_Phenotypes/Binary/Results/GeneCentric_ncRNA/"
# 
# input_path <- "/data/williamsjacr/UKB_WES_Phenotypes/Binary/Results/GeneCentricNoncoding/"
# output_path <- input_path
# ## number of jobs
...
#   write.csv(results_noncoding_genome,paste0("/data/williamsjacr/UKB_WES_Phenotypes/Binary/Results/GeneCentricNoncoding/",trait,"_noncoding_sig.csv"),row.names = FALSE)
# }
# 
# 
# 
