...
/data/williamsjacr/software/plink2 --pfile /data/williamsjacr/UKB_WES_lipids/Data/pVCF/chr${SLURM_ARRAY_TASK_ID}/ukbb_wes_200k_chr${SLURM_ARRAY_TASK_ID}_common --keep /data/williamsjacr/UKB_WES_lipids/Data/reference.txt --make-pgen --out /data/williamsjacr/UKB_WES_lipids/Data/pVCF/chr${SLURM_ARRAY_TASK_ID}/ukbb_wes_200k_chr${SLURM_ARRAY_TASK_ID}_common_reference
